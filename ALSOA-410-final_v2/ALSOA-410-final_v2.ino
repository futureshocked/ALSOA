...
void loop(){
  ...
  // the light source is towards the left, so robot should turn left. 
            ...
            SensorRight       >= threshold/2 //&&            
//            SensorRight      >= threshold/2  // THIS STATEMENT IS NOT NEEDED BECAUSE THE LEFT SENSOR HAS A STRONG SINGAL FROM THE LIGHT SOURCE
            ) 
            { 
              Serial.print("Right");
              leftMotor.write(LForward); 
  ...
  // the light source is towards the right, so robot should turn right. 
            ...
            SensorLeft       >= threshold/2  //&&            
//            SensorRight      >= threshold/2 //  // THIS STATEMENT IS NOT NEEDED BECAUSE THE RIGHT SENSOR HAS A STRONG SINGAL FROM THE LIGHT SOURCE
            ) 
            { 
                Serial.print("Left");
